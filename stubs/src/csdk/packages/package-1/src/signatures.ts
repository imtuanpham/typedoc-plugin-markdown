...
export const functionWithTypeParams2 = <T, Item = boolean | string>() => true;
 ...
 * @returns Return comments
 */
export function commentsInReturn2() {
  return true;
}
...
export let functionDeclaration2: (someArg: number) => boolean;
...
//   anotherParam: string,
// ) {
//   anotherParam = foo.toString() + bar.toString();
// }
